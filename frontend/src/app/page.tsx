...
import HistoryRecallPanel from '../components/HistoryRecallPanel'
      ...
      <div className="flex min-h-[calc(100vh-4rem)]">
        ...
        <div className="flex-1 p-6">
          <div className="grid grid-cols-12 gap-6 h-full">
            {/* Command Panel - Full Width Top */}
            <div className="col-span-12">
              <AgentCommandPanel 
                selectedAgent={selectedAgent}
                onExecutionStart={() => setExecutionStatus('running')}
                onExecutionComplete={() => setExecutionStatus('completed')}
                onExecutionError={() => setExecutionStatus('error')}
              />
            </div>
